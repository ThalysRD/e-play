        ...
        <div className={styles.pageContainer}>
            ...
            <main className={styles.body}>
                <div className={styles.formInfosPessoais}>
                    ...
                    <PersonalInfosForm onOpenModal={() => setIsModalOpen(true)} />
                </div>
                ...
                <div className={styles.formSenha}>
                    ...
                    <PasswordForm onOpenModal={() => setIsModalOpen(true)} />
                </div>
            </main>
...
function PersonalInfosForm({ onOpenModal }) {
    return (
            ...
            <div className={styles.formBackground}>
                <div className={styles.passwordFormContainer}>
                    <div className={styles.fieldGroup}>
                        ...
                        <input id="password" name="password" className={styles.input} />
                    </div>
