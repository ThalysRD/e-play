            ...
            <>
              ...
              <div className={styles.userInfoText}>
                ...
                <div className={styles.userDetails}>
                  ...
                  <div className={styles.column}>
                    <p>
                      <span className={`${styles.label} ${styles.bioLabel}`}>
                        Sobre mim:
                      </span>{" "}
                      {user.profile_bio || "Não informado"}
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className={styles.optionsContainer}>
          ...
          <section className={styles.section}>
            ...
            <div className={styles.buttonsGrid}>
              <Link
                href="/configuracoes/editar-perfil"
                className={`${styles.optionButton} ${styles.btnPurple}`}
              >
              ...
              <Link
                href="/configuracoes/lista-desejos"
